...
const botStrings = {
    ru: {
        // Onboarding
        welcomeNew: (name) => `👋 Привет, *${name}*! Добро пожаловать в твой Эмоциональный Дневник.\n\nПрежде чем начать, как ты планируешь использовать это приложение?`,
        roleTherapist: '🧠 Я профессионал (Психотерапевт)',
        roleClient: '📝 Я веду личный дневник',
        welcomeBack: (name) => `👋 Привет, *${name}*! Рад снова видеть тебя.\n\nОтправь любое сообщение, и я сохраню его как запись в дневнике. Или открой журнал напрямую:`,
        openJournal: '📖 Открыть дневник',
        viewEntry: '📖 Открыть запись',
        writeNow: '✍️ Написать сейчас',
        ...
        inviteAsClient: (name, therapistName) => `👋 Здравствуйте, *${name}*!\n\nВаш психотерапевт *${therapistName}* пригласил вас вести Эмоциональный Дневник. 🌊\n\nПриложение поможет отслеживать ваши эмоции, которыми вы сможете делиться с терапевтом во время сессий.\n\nОткройте журнал, чтобы начать:`,
